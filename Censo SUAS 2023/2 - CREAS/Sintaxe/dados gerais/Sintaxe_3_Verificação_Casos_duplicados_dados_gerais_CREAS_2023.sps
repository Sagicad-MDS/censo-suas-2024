...
* ----Duplicação por Número Identificador : 0 casos
...
SORT CASES BY q0_1(A) q0_2(A) q0_3(A) q0_4(A) q0_5(A) q0_6(A) q0_7(A) 
   q0_8(A) q0_9(A) q0_10(A) q0_11(A) q0_12(A) q0_13(A)  q0_15(A).
MATCH FILES
  /FILE=*
  /BY q0_1 q0_2   q0_3  q0_4  q0_5  q0_6  q0_7   q0_8  q0_9   q0_10   q0_11  q0_12  q0_13  q0_15
  /FIRST=PrimaryFirst
  /LAST=PrimaryLast_2.
DO IF (PrimaryFirst).
...
* ----> Endereço e IBGE: 6 casos - Colocados na planilha para verificação
