...
COMPUTE  Idade=DATEDIF(DataCenso_2020, q37_2_rec, "years"). 
...
RECODE q37_11  (SYSMIS=SYSMIS) (138=1) (139=2) (292=3) (ELSE=4) INTO d37_11.
...
VARIABLE LABELS d37_10bin4  'd37_10 bin4_Advogado'.
EXECUTE.
...
VARIABLE LABELS  d37_10bin5  'd37_10bin5_Psicólogo'.
EXECUTE.
...
VARIABLE LABELS
d37_9bin1_sum 'd37_9bin1_sum_Número de trabalhadores de Nível fundamental (inclui trabalhadores sem escolaridade, fundamental incompleto e ensino médio incompleto)'
d37_9bin2_sum 'd37_9bin2_sum_Número de trabalhadores de Nível médio (inclui trabalhadores com ensino superior incompleto)'
d37_9bin3_sum 'd37_9bin3_sum_Número de trabalhadores de Nível superior (inclui trabalhadores com especialização, mestrado e doutorado)'
d37_10bin1_sum 'd37_10bin1_sum_Número de Pedagogos'
d37_10bin2_sum 'd37_10bin2_sum_Número de Assistentes Sociais'
d37_10bin3_sum 'd37_10bin3_sum_Número de Antropólogos'
d37_10bin4_sum 'd37_10bin4_sum_Número de Advogados'
d37_10bin5_sum 'd37_10bin5_sum_Número de Psicólogos'
d37_11bin1_sum 'd37_11bin1_sum_Número de Servidores Estatutários'
d37_11bin2_sum 'd37_11bin2_sum_Número de Empregados Públicos(CLT)'
d37_11bin3_sum 'd37_11bin3_sum_Número de Comissionados'
d37_11bin4_sum 'd37_11bin4_sum_Número de profissionais com outros vínculos não permanentes'
...
VARIABLE LABELS
nu_familias 'Número de familias acolhedoras na unidade executora do serviço de acolhimento em familia acolhedora'.
EXECUTE.
