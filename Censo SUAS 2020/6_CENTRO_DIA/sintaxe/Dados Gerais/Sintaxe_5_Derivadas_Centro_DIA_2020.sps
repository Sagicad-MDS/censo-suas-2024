...
*********QUESTÃO 25- Capacidade de atendimento usuarios por turno
...
VARIABLE LABELS
d35_1  'Crianças de 0 a 6 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d35_2  'Crianças e adolescentes de 7 a 14 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d35_3  'Adolescentes de 15 a 17 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d35_4  'Jovens e adulto (18 a 59 anos) com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d35_5  'Idosas(os) (60 anos ou mais) com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d35_7_total  'Total de pessoas atendidas no Serviço no  mês de agosto de 2020'.
EXECUTE.
...
VARIABLE LABELS
d36_3  'Total de pessoas atendidas com Deficiência auditiva'.
EXECUTE.
...
VARIABLE LABELS
d36_4  'Total de pessoas atendidas com Deficiência intelectual'.
EXECUTE.
...
VARIABLE LABELS
d37_1  'Total de pessoas atendidas Idosas(os) beneficiárias(os) do BPC'.
EXECUTE.
...
VARIABLE LABELS
d37_4  'Total de pessoas atendidas com famílias beneficiárias do PBF'.
EXECUTE.
...
VARIABLE LABELS
d38_2 'Total de usuarios que ficam na unidade em meio período'.
EXECUTE.
...
VARIABLE LABELS
d38_3 'Total de usuarios que ficam na unidade em periodo menor do que meio período'.
EXECUTE.
...
VARIABLE LABELS
d43   'Quantos profissionais participaram de curso sobre o Serviços de PSE para Pessoas com Deficiência, Idosas e suas famílias?'.
EXECUTE.
