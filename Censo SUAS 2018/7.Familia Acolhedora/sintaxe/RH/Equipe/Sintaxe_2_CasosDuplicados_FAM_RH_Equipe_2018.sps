...
SORT CASES BY NU_IDENTIFICADOR(A) q_33_4(A) q_33_12(D). 
MATCH FILES 
  /FILE=* 
  /BY NU_IDENTIFICADOR q_33_4 
  /FIRST=PrimaryFirst 
  /LAST=PrimaryLast. 
DO IF (PrimaryFirst). 
...
***Casos totais anterior: 1030 - 1020 municipal e 10 estadual
***Casos duplicados: 2 municipal
***Casos totais sem duplicados: 1028  - 1018 Muniicipal e 10 estadual.
