...
* 10.Em caso de Unidade Estadual Governamental, indique como está organizada a gestão administrativa desta unidade

 * Custom Tables. 
CTABLES 
  /VLABELS VARIABLES=q10_1_1  q10_1_2  q10_1_3  q10_1_0   DISPLAY=LABEL 
  /TABLE q10_1_1 [COUNT F40.0] + q10_1_2 [COUNT F40.0] + q10_1_3 [COUNT F40.0] + q10_1_0 [COUNT F40.0] 
  /CATEGORIES VARIABLES=q10_1_1  q10_1_2  q10_1_3  q10_1_0 [1] EMPTY=INCLUDE 
  /TITLES 
 ...
 * Custom Tables. 
CTABLES 
  /VLABELS VARIABLES=q10_2_1  q10_2_2  q10_2_3  q10_2_0   DISPLAY=LABEL 
  /TABLE q10_2_1 [COUNT F40.0] + q10_2_2 [COUNT F40.0] + q10_2_3 [COUNT F40.0] + q10_2_0 [COUNT F40.0] 
  /CATEGORIES VARIABLES=q10_2_1  q10_2_2  q10_2_3  q10_2_0 [1] EMPTY=INCLUDE 
  /TITLES 
 ...
 * Custom Tables. 
CTABLES 
  /VLABELS VARIABLES=q10_3_1  q10_3_2  q10_3_3  q10_3_0   DISPLAY=LABEL 
  /TABLE q10_3_1 [COUNT F40.0] + q10_3_2 [COUNT F40.0] + q10_3_3 [COUNT F40.0] + q10_3_0 [COUNT F40.0] 
  /CATEGORIES VARIABLES=q10_3_1  q10_3_2  q10_3_3  q10_3_0 [1] EMPTY=INCLUDE 
  /TITLES 
 ...
 * Custom Tables. 
CTABLES 
  /VLABELS VARIABLES=q10_4_1  q10_4_2  q10_4_3  q10_4_0   DISPLAY=LABEL 
  /TABLE q10_4_1 [COUNT F40.0] + q10_4_2 [COUNT F40.0] + q10_4_3 [COUNT F40.0] + q10_4_0 [COUNT F40.0] 
  /CATEGORIES VARIABLES=q10_4_1  q10_4_2  q10_4_3  q10_4_0 [1] EMPTY=INCLUDE 
  /TITLES 
    TITLE='Provisão de Transporte'.
...
CTABLES
  /VLABELS VARIABLES=q_1_1   D29_1 DISPLAY=DEFAULT
  /TABLE q_1_1 [C] BY  D29_1 [C][COUNT F40.0] 
  /CATEGORIES VARIABLES=q_1_1  D29_1 ORDER=A KEY=VALUE EMPTY=INCLUDE total=yes.




CTABLES
  /VLABELS VARIABLES=q_1_1  D29_2 DISPLAY=DEFAULT
  /TABLE q_1_1 [C] BY  D29_2 [C][COUNT F40.0] 
  /CATEGORIES VARIABLES=q_1_1  D29_2 ORDER=A KEY=VALUE EMPTY=INCLUDE total=yes.
