...
RECODE q_75_6 ("U", "O", "E","T" =1) INTO d75_6bin5.
VARIABLE LABELS  d75_6bin5  'd75_6bin5_Representante da Sociedade Civil'.
EXECUTE.
...
DO IF  (q_75_7 = 20 | q_75_7 = 308 | q_75_7 = 105).
RECODE d75_6bin5 (1=1) INTO d75_6bin5_TIT.
END IF.

VARIABLE LABELS  d75_6bin5_TIT  'd75_6bin5_TIT_Representante Titular da Sociedade Civil'.
EXECUTE.


DO IF  (q_75_7 = 106).
RECODE d75_6bin5 (1=1) INTO d75_6bin5_SUPL.
END IF.

VARIABLE LABELS  d75_6bin5_SUPL 'd75_6bin5_SUPL_Representante Suplente da Sociedade Civil'.
EXECUTE.
...
AGGREGATE
  /BREAK=IBGE
  /d75_6bin5_TIT_sum=SUM(d75_6bin5_TIT)
  /d75_6bin5_SUPL_sum=SUM(d75_6bin5_SUPL).
EXECUTE.
...
RECODE d75_6bin1_sum  d75_6bin2_sum  d75_6bin3_sum  d75_6bin4_sum   d75_6bin5_sum  nu_conselheiros 
    (SYSMIS=0).
EXECUTE.
...
RECODE d75_6bin1_TIT_sum  d75_6bin1_SUPL_sum  d75_6bin2_TIT_sum  d75_6bin2_SUPL_sum  d75_6bin3_TIT_sum  d75_6bin3_SUPL_sum  d75_6bin4_TIT_sum  d75_6bin4_SUPL_sum
 d75_6bin5_TIT_sum  d75_6bin5_SUPL_sum   (SYSMIS=0).
EXECUTE.
...
d75_6bin1_sum	'd75_6bin1_sum_Representante de usuários e organização de usuários'
  ...
  /d75_6bin5_sum	'd75_6bin5_sum_Representante da Sociedade Civil'
  ...
  /d75_6bin5_TIT_sum    'd75_6bin5_TIT_sum.Representante Titular da Sociedade Civil'
  /d75_6bin5_SUPL_sum    'd75_6bin5_SUPL_sum.Representante Suplente da Sociedade Civil'
/nu_conselheiros	'Quantidade de conselheiros'
.
EXECUTE.


dataset declare aggr.RH.conselho2018.
AGGREGATE
/outfile='aggr.RH.conselho2018'
  /BREAK=IBGE
  /d75_6bin1_sum=SUM(d75_6bin1)
  /d75_6bin2_sum=SUM(d75_6bin2)
  /d75_6bin3_sum=SUM(d75_6bin3)
