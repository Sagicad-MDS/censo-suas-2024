...
* Custom Tables.
CTABLES
  /VLABELS VARIABLES=Regiao UF q_73_2 q_73_3 q_73_4 DISPLAY=LABEL
  /TABLE Regiao [C] + UF [C] BY q_73_2 [S][SUM] + q_73_2 [S][SUM] + q_73_3 [S][SUM] + q_73_4 
    [S][SUM]
  /CATEGORIES VARIABLES=Regiao [1.00, 2.00, 3.00, 4.00, 5.00, OTHERNM] EMPTY=INCLUDE TOTAL=YES 
    POSITION=AFTER
  /CATEGORIES VARIABLES=UF [11.00, 12.00, 13.00, 14.00, 15.00, 16.00, 17.00, 21.00, 22.00, 23.00, 
    24.00, 25.00, 26.00, 27.00, 28.00, 29.00, 31.00, 32.00, 33.00, 35.00, 41.00, 42.00, 43.00, 50.00, 
    51.00, 52.00, 53.00, OTHERNM] EMPTY=INCLUDE TOTAL=YES POSITION=AFTER.
...
CTABLES
  /VLABELS VARIABLES=Regiao UF q_74_1 q_74_2 q_74_3 q_74_4 q_74_5 q_74_6 
    DISPLAY=LABEL
  /TABLE Regiao [C] + UF [C] BY q_74_1 [S][SUM] + q_74_2 [S][SUM] + q_74_3 [S][SUM] + q_74_4 
    [S][SUM] + q_74_5 [S][SUM] + q_74_6 [S][SUM]
  /CATEGORIES VARIABLES=Regiao [1.00, 2.00, 3.00, 4.00, 5.00, OTHERNM] EMPTY=INCLUDE TOTAL=YES 
    POSITION=AFTER
  /CATEGORIES VARIABLES=UF [11.00, 12.00, 13.00, 14.00, 15.00, 16.00, 17.00, 21.00, 22.00, 23.00, 
    24.00, 25.00, 26.00, 27.00, 28.00, 29.00, 31.00, 32.00, 33.00, 35.00, 41.00, 42.00, 43.00, 50.00, 
