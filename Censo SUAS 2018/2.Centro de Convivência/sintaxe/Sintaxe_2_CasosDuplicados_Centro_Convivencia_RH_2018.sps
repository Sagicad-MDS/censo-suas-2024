...
SORT CASES BY NU_IDENTIFICADOR(A) q_31_4 (A) q_31_12(D). 
MATCH FILES 
  /FILE=* 
  /BY NU_IDENTIFICADOR q_31_4 
  /FIRST=PrimaryFirst 
  /LAST=PrimaryLast. 
DO IF (PrimaryFirst). 
...
***Casos totais anterior: 68638
***Casos duplicados: 232
***Casos totais sem duplicados: 68406
