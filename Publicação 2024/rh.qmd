...
```{r fig-qtd_trab_munic, fig.cap ="Evolução da quantidade de trabalhadoras/es nas Secretarias Municipais de Assistência Social - Brasil e grandes regiões, 2018 a 2024"}
#| fig-height: 6
...
```{r fig-uf_trab_vin, fig.cap ="Percentual de trabalhadoras/es nas Secretarias Estaduais de Assistência Social, segundo tipo de vínculo - Brasil, 2018 a 2024"}
...
```{r fig-munic_trab_vin, fig.cap ="Percentual de trabalhadoras/es nas Secretarias Municipais de Assistência Social, segundo tipo de vínculo - Brasil, 2018 a 2024"}
...
```{r fig-uf_trab_form, fig.cap ="Percentual de trabalhadoras/es nas Secretarias Estaduais de Assistência Social segundo escolaridade - Brasil, 2018 a 2024"}
...
```{r fig-munic_trab_form, fig.cap ="Percentual de trabalhadoras/es nas Secretarias municipais, segundo escolaridade - Brasil, 2018 a 2024"}
...
```{r fig-uf_trab_prof, fig.cap ="Percentual de trabalhadoras/es nas Secretarias estaduais de Assistência Social, segundo área de formação - Brasil, 2018, 2022,2023 e 2024"}
# #| fig-height: 9
...
tabela <- 
  ...
  bind_rows(f_formacao(gerh_2024, q41_10, "2024")) %>%
  f_profissao(Eixo_x) %>%
...
```{r fig-munic_trab_prof, fig.cap ="Percentual de trabalhadoras/es nas Secretarias municipais de Assistência Social, segundo área de formação - Brasil, 2018, 2022 2023 e 2024"}
# #| fig-height: 10
...
tabela <- 
  ...
  bind_rows(f_formacao(gmrh_2024, q76_10, "2024")) %>%
  f_profissao(Eixo_x) %>%
  f_calcula_percentual(Grupo, Eixo_x, Eixo_y)
...
```{r fig-trab-unidades, fig.cap ="Evolução da quantidade de trabalhadoras/es dos CRAS, CREAS e Centro POP - Brasil; 2012, 2017, 2022, 2023 e 2024" }
