...
A estrutura administrativa na Política de Assistência Social e a constituição de setores essenciais são elementos importantes para a gestão do SUAS. No âmbito da gestão estadual percebe-se que desde 2012 há uma redução de secretarias estaduais exclusivas de Assistência Social. Em 2012, 8 Estados (31% dos 26 Estados)[^gestao-1] tinham secretarias estaduais exclusivas da área de Assistência Social. Esse número vem apresentando redução ao longo do tempo, e o Censo SUAS 2024 indica que atualmente apenas 2 estados (7,7%) se enquadram nessa situação, conforme pode ser observado no gráfico. (@fig-estados_sec_exc).
...
O @fig-estados-caracteristica-secretaria mostra a quantidade de outras políticas setoriais que estão incorporadas nas pastas da Assistência Social estaduais. Vemos que na maioria dos estados a Secretaria Estadual responsável pela área de Assistência Social incorpora outras três ou quatro políticas setoriais.

```{r fig-estados-caracteristica-secretaria, fig.cap = "Quantidade de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
...
Na estrutura administrativa da Assistência Social nos Municípios observa-se, em 2024, um aumento no percentual de Municípios que possuem secretaria municipal exclusiva da área de Assistência Social (@fig-sec-munic-exc). De 2012 a 2019 esse percentual oscilou entre 77% e 79%, de 2020 a 2022 essa pergunta foi retirada do formulário da Gestão Municipal, e, na volta da pergunta, os dados de 2024, o percentual de Municípios que possuem secretaria municipal exclusiva da área de Assistência Social encontra-se com 81%.
...
```{r fig-uf_subd, fig.cap = "Percentual de Estados segundo constituição de subdivisões administrativas na estrutura do órgão gestor - Brasil; 2012, 2015, 2020 e 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 8
...
```{r fig-munic_sub, fig.cap = "Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2012 e 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 6
...
grafico<-ge_2024 %>%
  ...
  mutate(x = case_when(x <= 2017~"Até 2017",
                            TRUE ~ as.character(x))) %>%
  mutate(x = factor(x, levels = c("Até 2017","2018","2019","2020","2021","2022","2023","2024"))) %>%
...
```{r fig-munic_ord_despesa, fig.cap = "Percentual de Municípios quanto a ordenação de despesa do Fundo Municipal - Brasil, 2012 a 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
