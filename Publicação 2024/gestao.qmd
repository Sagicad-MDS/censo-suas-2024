...
```{r fig-uf_subd, fig.cap = "Percentual de Estados segundo constituição de subdivisões administrativas na estrutura do órgão gestor - Brasil; 2012, 2023 e 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 8
...
```{r fig-munic_sub, fig.cap = "Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2012, 2022, 2023 e 2024", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 6
