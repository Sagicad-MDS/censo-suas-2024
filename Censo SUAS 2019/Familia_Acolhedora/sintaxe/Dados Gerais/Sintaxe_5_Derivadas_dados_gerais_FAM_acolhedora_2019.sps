...
RECODE q13 (Lowest thru 100=1) (101 thru 500=2) (501 thru 1000=3) (1000 thru Highest=4) INTO 
    d_13_faixa.
EXECUTE.
...
RECODE q14 (Lowest thru 10=1) (11 thru 50=2) (51 thru 100=3) (100 thru Highest=4) INTO 
    d_14_faixa.
EXECUTE.
...
RECODE q15 (Lowest thru 10=1) (11 thru 50=2) (51 thru 100=3) (100 thru Highest=4) INTO 
    d_15_faixa.
EXECUTE.
...
COMPUTE q_16_1_7_recod=SUM(q16_1_1,q16_1_2,q16_1_3,q16_1_4,q16_1_5,q16_1_6).
EXECUTE.
 VARIABLE LABELS
...
COMPUTE q_16_2_7_recod=SUM(q16_2_1,q16_2_2,q16_2_3,q16_2_4,q16_2_5,q16_2_6).
EXECUTE.
 VARIABLE LABELS
...
COMPUTE q_17_9_recod=SUM(q17_1,q17_2,q17_3,q17_4,q17_5,q17_6, q17_7, q17_8).
EXECUTE.
 VARIABLE LABELS
