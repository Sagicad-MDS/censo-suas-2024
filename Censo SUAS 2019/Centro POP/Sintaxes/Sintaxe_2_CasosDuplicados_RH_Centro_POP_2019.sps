...
SORT CASES BY NU_IDENTIFICADOR(A) q33_4(A) q33_12_recategorizada(D). 
MATCH FILES 
  /FILE=* 
...
* A variável  q33_12_recategorizada foi criada apenas para limpeza dos casos duplicados, com a recategorização do valor "Educador(a) social". A variável que permaneceu na base foi a q33_12, com seus value labels originais.  

***Casos totais anterior: 3174
***Casos totais sem duplicados: 3169
