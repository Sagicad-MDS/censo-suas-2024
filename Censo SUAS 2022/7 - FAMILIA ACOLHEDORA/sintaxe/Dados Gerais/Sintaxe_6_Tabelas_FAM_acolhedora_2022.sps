...
**CENSO SUAS 2022 - Familia Acolhedora**
...
FREQUENCIES VARIABLES=q6 q7 q8 q9  q10 q11 
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES= d12_faixa  q12_98 q13 q14  
  /ORDER=ANALYSIS.
...
CTABLES
  /VLABELS VARIABLES=q17_1_1 q17_1_2 q17_1_3 q17_1_4 q17_1_5 q17_1_6 q17_1_7 q17_1_8   q17_1_9_recod
    q17_2_1 q17_2_2 q17_2_3 q17_2_4 q17_2_5 q17_2_6 q17_2_7 q17_2_8 q17_2_9_recod
    DISPLAY=LABEL
  /TABLE q17_1_1 [S][SUM] + q17_1_2 [S][SUM] + q17_1_3 [S][SUM] + q17_1_4 [S][SUM] + q17_1_5 
    [S][SUM] + q17_1_6 [S][SUM] + q17_1_7 [S][SUM] + q17_1_8 [S][SUM]     + q17_1_9_recod  [S][SUM] +  q17_2_1 
    [S][SUM] + q17_2_2 [S][SUM] + q17_2_3 [S][SUM] + q17_2_4 [S][SUM] + q17_2_5 [S][SUM] + q17_2_6 
    [S][SUM] + q17_2_7 [S][SUM] + q17_2_8 [S][SUM]   + q17_2_9_recod [S][SUM] .
...
CTABLES
  /VLABELS VARIABLES=q18_1 q18_1_98 q18_2 q18_2_98  q18_3 q18_3_98 DISPLAY=LABEL
  /TABLE q18_1 [S][SUM] + q18_1_98 [COUNT F40.0] + q18_2 [S][SUM] + q18_2_98 [COUNT F40.0] + q18_3 [S][SUM] + q18_3_98 [COUNT F40.0]
  /CATEGORIES VARIABLES=q18_1_98  q18_2_98  q18_3_98 ORDER=A KEY=VALUE EMPTY=EXCLUDE.



CTABLES
  /VLABELS VARIABLES=q19_1  q19_2 q19_3   q19_4  q19_5  q19_6  q19_7  q19_8  q19_9  q19_10
    DISPLAY=LABEL
  /TABLE q19_1 [S][SUM] + q19_2  [S][SUM] + q19_3 [S][SUM] + q19_4 [S][SUM] + q19_5 
    [S][SUM] + q19_6 [S][SUM] + q19_7 [S][SUM] + q19_8 [S][SUM]     +q19_9  [S][SUM] + q19_10 
    [S][SUM]  .



FREQUENCIES VARIABLES=q20_1 q20_1_98 q20_2 q20_2_98 q20_3 q20_3_98 q20_4 q20_4_98 q20_5 q20_5_98 q20_6 q20_6_98 
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES= q21_1 q21_1_98 q21_2 q21_2_98 q21_3 q21_3_98 
  /ORDER=ANALYSIS.



FREQUENCIES VARIABLES= q22_1 q22_1_98 q22_2 q22_2_98 q22_3 q22_3_98 q22_4 q22_4_98 q22_5 q22_5_98
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES= q23  q23_98  d23_faixa
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES=   d26_1_faixa d26_2_faixa  q26_3
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES=   q31 qq32_2  q32_1
  /ORDER=ANALYSIS.
