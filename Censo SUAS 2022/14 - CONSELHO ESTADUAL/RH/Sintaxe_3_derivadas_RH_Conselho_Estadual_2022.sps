...
**Criação de Derivadas Conselheiros - RH Conselhos - CENSO 2022**
...
COMPUTE  Idade=DATEDIF(DataCenso_2022, q85_2_rec, "years"). 
...
VARIABLE LABELS  d85_5bin1  'Nível fundamental - Conselheiros que possuem até o nível médio (inclui aqueles sem escolaridade)'.
EXECUTE.

VALUE LABELS d85_5bin1
1 'Nível fundamental'.
EXECUTE.
