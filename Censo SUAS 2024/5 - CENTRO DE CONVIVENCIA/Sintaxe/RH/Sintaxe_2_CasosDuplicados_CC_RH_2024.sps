...
RECODE q38_12 (21=0) (218=1)  (217=2) (216=3) (ELSE=99) INTO Função_recode.
EXECUTE.

SORT CASES BY NU_IDENTIFICADOR(A) q38_4(A) Função_recode(A).

* Identificar casos duplicados.
SORT CASES BY NU_IDENTIFICADOR(A) q38_4(A).
MATCH FILES
  /FILE=*
  /BY NU_IDENTIFICADOR q38_4
  /FIRST=PrimaryFirst
  /LAST=PrimaryLast.
DO IF (PrimaryFirst).
