...
VARIABLE LABELS
d17_veiculo	'd17 - Possui Veículo (exclusivo, compartilhado ou adaptado)'.
EXECUTE.
...
VARIABLE LABELS   d17_24_1 ' d17_24_1_Quantidade de camas/colchonetes'.
EXECUTE.
...
VARIABLE LABELS  d18_1 ' d18_1_Quantidade de computadores, em perfeito funcionamento, existentes'.
...
VARIABLE LABELS  d18_3  'd18_3.Quantidade de computadores conectados à internet  diponiveis para os usuários do Centro Dia'.
EXECUTE.
...
VARIABLE LABELS  d18_2  'd18_2.Quantidade de computadores conectados à internet no Centro Dia'.
EXECUTE.




*********QUESTÃO 22 Capacidade de atendimento usuarios por turno
...
VARIABLE LABELS
d30_lista_espera      'd30_quantas pessoas estão neste momento em lista de espera'.
EXECUTE.
...
VARIABLE LABELS
d31_1  'Crianças de 0 a 6 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_2  'Crianças e adolescentes de 7 a 14 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_3  'Adolescentes de 15 a 17 anos, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_4  'Jovens e adulto (18 a 59 anos) com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_5  ' Idosas (os) de 60 a 79 anos com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_6  ' Idosas(os) com 80 anos ou mais, com deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_7  'Idosas (os) com 60 a 79 anos, dependentes pela idade, sem deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_8  ' Idosas(os) com 80 anos ou mais, dependentes pela idade, sem deficiência'.
EXECUTE.
...
VARIABLE LABELS
d31_9_total  'Total de pessoas atendidas no Serviço no mês de agosto de 2023'.
EXECUTE.
...
VARIABLE LABELS
d32_1  'Total de pessoas atendidas com Deficiência física'.
EXECUTE.
...
VARIABLE LABELS
d32_2  'Total de pessoas atendidas com Deficiência visual'.
EXECUTE.
...
VARIABLE LABELS
d32_3  'Total de pessoas atendidas com Deficiência auditiva'.
EXECUTE.
...
VARIABLE LABELS
d32_4  'Total de pessoas atendidas com Deficiência intelectual'.
EXECUTE.
...
VARIABLE LABELS
d32_5  'Total de pessoas atendidas com Deficiência mental'.
EXECUTE.
...
VARIABLE LABELS
d33_1  'Total de pessoas atendidas Idosas(os) beneficiárias(os) do BPC'.
EXECUTE.
...
VARIABLE LABELS
d33_2  'Total de pessoas atendidas com Deficiência beneficiárias do BPC'.
EXECUTE.
...
VARIABLE LABELS
d33_3  'Total de pessoas atendidas que recebem pensão/aposentadoria'.
EXECUTE.
...
VARIABLE LABELS
d33_4  'Total de pessoas atendidas que recebem a Pensão Especial por Microcefalia'.
EXECUTE.
...
VARIABLE LABELS
d34_2 'Total de usuarios que ficam na unidade em meio período'.
EXECUTE.
...
VARIABLE LABELS
d34_3 'Total de usuários que ficam na unidade em menos do que meio período'.
EXECUTE.
