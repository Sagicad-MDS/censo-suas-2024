...
COMPUTE q15_2_rec=number(q15_2, EDATE10).
VARIABLE LABELS q15_2_rec "q15_2_data nascimento recodificada".
VARIABLE LEVEL  q15_2_rec (SCALE).
FORMATS q15_2_rec (EDATE10).
VARIABLE WIDTH  q15_2_rec(10).
EXECUTE.


**transformar em data**

COMPUTE  Idade=DATEDIF(DataCenso_2021, q15_2_rec, "years"). 
...
VARIABLE LABELS d15_10bin4   'd15_10bin4_Outros vínculos não permanentes - inclui Trabalhador de Empresas/Cooperativa/Entidade Prestadora de Serviços; Voluntários; Servidor Temporário; Sem vínculo; Terceirizado e Outro vínculo não permanente'.
...
VARIABLE LABELS
d15_8bin1_sum   'd15_8bin1_sum_Número de trabalhadores de Nível fundamental (inclui trabalhadores sem escolaridade, fundamental incompleto e ensino médio incompleto)'
d15_8bin2_sum  'd15_8bin2_sum_Número de trabalhadores de Nível médio (inclui trabalhadores com ensino superior incompleto)'
d15_8bin3_sum  'd15_8bin3_sum _Número de trabalhadores de Nível superior (inclui trabalhadores com especialização, mestrado e doutorado)'.
EXECUTE.
