...
* ----Duplicação por q0_1(A) q0_3(A) q0_4(A) q0_5(A) q0_6(A) q0_7(A) q0_8(A) q0_9(A) q0_10(A). = 1 caso
***municipio de Itaituba/PA  justificou em 290322 Informo que houve um equivoco quanto ao endereço das unidades de acolhimento provisório, o que ja fizemos a correção do endereço.
*** ID 1503603311442 e 1503603311444.
...
* ----Duplicação por q0_3(A) q0_4(A) q0_6(A) = 103 casos
